...
imgBackground = cv2.imread("Smart_Voting.png")
    ...
    if output is not None:
        ...
        if k == ord('1'):
            ...
            if exist:
                with open("Votes.csv", "a") as csvfile:
                    ...
                    attendance = [output[0], "Party A", date, timestamp]
        ...
        if k == ord('2'):
            ...
            if exist:
                with open("Votes.csv", "a") as csvfile:
                    writer = csv.writer(csvfile)
                    attendance = [output[0], "Party B", date, timestamp]
                    writer.writerow(attendance)
            else:
                with open("Votes.csv", "a") as csvfile:
                    writer = csv.writer(csvfile)
        ...
        if k == ord('3'):
            ...
            if exist:
                with open("Votes.csv", "a") as csvfile:
                    writer = csv.writer(csvfile)
                    attendance = [output[0], "Party C", date, timestamp]
                    writer.writerow(attendance)
            else:
                with open("Votes.csv", "a") as csvfile:
                    writer = csv.writer(csvfile)
